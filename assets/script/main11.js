...
if(document.getElementById('online-visit')){
  online_visit = new Vue({
    ...
    methods: {
      ...
      upload_image_to_dropbox: function(){
      ...
      validate: function(step){
        ...
        switch(may_be_step){
          ...
          case 2:
            ...
            break;
          case 3:
            valid = !!this.photo_1 && !!this.photo_2;
      ...
      set_status_class: function(name, mode){
        switch(mode){
          case 'class':
            return this[name] ?  'loaded' : 'not-loaded';
            break;
          case 'text':
            return this[name] ?  'Uploaded' : 'Not Uploaded';
            break;
        };
      },
